                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount"><span class="font-lg fw-600 text-brand">${{Cart::subtotal()}}</span></td>
                                                </tr>
                                                <tr>
                                                    <td class="cart_total_label">Tax</td>
                                                    <td class="cart_total_amount"><span class="font-lg fw-600 text-brand">${{Cart::tax()}}</span></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount"><strong><span class="font-xl fw-600 text-brand">${{Cart::total()}}</span></strong></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
